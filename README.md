...
Current development has moved to a private GitHub repository. For inquiries, contact [Dominic Mashak](mailto:mashakd@southwestern.edu)
...
*Uses [v0.2.5](https://github.com/DominicMashak/Molecular-Evolution/releases/tag/v0.2.5) of this repository.*

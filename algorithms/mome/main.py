  ...
  python mome_main.py --calculator semiempirical --se-method PM7 \\
    ...
    parser.add_argument('--cvt-measures', type=str, default='structural',
                       ...
                       help='CVT measure type: structural (num_atoms/bonds), '
                            'embedding (ChemBERTa for molecules / MatText for crystals), or '
    ...
    # Default objectives for crystal encoding (require at least 2)
    if args.encoding == 'slices' and args.objectives == ['beta_mean', 'homo_lumo_gap']:

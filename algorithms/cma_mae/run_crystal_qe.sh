#!/bin/bash
set -euo pipefail
# Run CMA-MAE to evolve semiconductor crystals using QE DFT fitness.
...
OUTPUT_DIR="${SCRIPT_DIR}/cma_mae_crystal_${ELEMENT_SET}_seed_${SEED}"
...
echo "CMA-MAE crystal evolution"
echo "  Seed:        ${SEED}"

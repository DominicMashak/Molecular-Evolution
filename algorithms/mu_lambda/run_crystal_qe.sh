#!/bin/bash
set -euo pipefail
# Run mu+lambda EA to evolve semiconductor crystals using QE DFT fitness.
...
OUTPUT_DIR="${SCRIPT_DIR}/mu_lambda_crystal_${ELEMENT_SET}_seed_${SEED}"
...
echo "mu+lambda crystal evolution"
echo "  Seed:        ${SEED}"

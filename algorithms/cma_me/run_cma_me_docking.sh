#!/bin/bash
set -euo pipefail
# Run CMA-ME optimising docking score against a specific protein target.
#
# SmartCADD pipeline:
...
#
# Usage: bash run_cma_me_docking.sh [SEED] [PROTEIN_CODE]
...
OUTPUT_DIR="${SCRIPT_DIR}/cma_me_docking_${PROTEIN_CODE}_selfies_seed_${SEED}"

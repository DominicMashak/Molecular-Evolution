#!/bin/bash
set -euo pipefail
# Run MAP-Elites optimising docking score against a specific protein target.
#
# SmartCADD pipeline:
...
#
# Usage: bash run_map_elites_docking.sh [SEED] [PROTEIN_CODE]
...
OUTPUT_DIR="${SCRIPT_DIR}/map_elites_docking_${PROTEIN_CODE}_selfies_seed_${SEED}"

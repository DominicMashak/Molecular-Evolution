#!/bin/bash
# Run CTAEA on NLO molecules (4-objective, DFT/HF/3-21G).
# Two-archive EA with Das-Dennis ref_dirs.
# Pop size 84 = number of Das-Dennis reference directions for 4 objectives, 6 partitions.
#
# Usage: bash run_ctaea.sh [SEED]
#   SEED defaults to 42
...
OUTPUT_DIR="${SCRIPT_DIR}/ctaea_nlo_results_seed_${SEED}"
